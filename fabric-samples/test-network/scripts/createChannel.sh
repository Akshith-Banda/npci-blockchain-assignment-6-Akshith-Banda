...
infoln "Joining jio peer to the channel..."
joinChannel 1
infoln "Joining airtel peer to the channel..."
joinChannel 2

## Set the anchor peers for each org in the channel
infoln "Setting anchor peer for jio..."
setAnchorPeer 1
infoln "Setting anchor peer for airtel..."
setAnchorPeer 2
